...
namespace OnlinePizzaRestaurantWebApp.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.GenderID = new SelectList(Db.Genders.ToList(), "GenderID", "GenderTitle", "0");
            return View(user);
        }
        ...
        public ActionResult Register(Reg_UserMV reg_UserMV)
        {
            ...
            ViewBag.GenderID = new SelectList(Db.Genders.ToList(), "GenderID", "GenderTitle", reg_UserMV.GenderID);
        ...
        public ActionResult ResetPassword(string recoverycode)
        {
            ...
            var userrecovery = Db.UserPasswordRecoveryTables.Where(p => p.RecoveryCode == recoverycode && p.RecoveryCodeExpireDateTime > DateTime.Now && p.RecoveryStatus == true).FirstOrDefault();
